...
*Пояснение*
| Наименование ячейки таблицы | Пояснение |
|-----------------------------|-----------|
| полиномы                    |  Работа с полиномами |
| key|value                   | Разработка класса/структуры для хранения ключений и значений таблицы |
| базовая                     | Реализация класса базовой таблицы |
| линейная на списке	         | Разработка наследника базовой задачи |
| дерево авл                  | Разработка наследника базовой задачи |
| main                        | Разработка main для демонстрации |
| тесты                       | Разработка тестов |
| хэш 1                       | Разработка наследника базовой задачи: хэштаблица 1 |
| хэш 2                       | Разработка наследника базовой задачи: хэштаблица 2 |
